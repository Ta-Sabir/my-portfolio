...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <button className="flex items-center justify-between gap-1 p-[9px] w-fit mx-auto my-[8px] bg-[var(--main-color)] hover:bg-[var(--white-color)] text-[var(--white-color)] hover:text-[var(--main-color)] text-[15px] font-bold hover:scale-[1.01] hover:translate-y-[-4px] rounded-full transition-all">
